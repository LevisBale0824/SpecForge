export default {
  ...
  welcome: {
    ...
    intro: {
      kicker: "SpecForge",
      title: "AI 辅助开发工作台",
      sub: "集 AI 对话、Spec 工作流与项目会话管理于一体，从需求到落地全程可观察、可回溯。",
      capabilities: {
        chat: { title: "AI 对话", desc: "与 OpenCode / Zero Agent 实时协作，执行开发任务" },
        workflow: { title: "Spec 工作流", desc: "按改动规模走 4–7 步结构化探索流程" },
        project: { title: "项目管理", desc: "多项目切换，会话自动关联目录与上下文" },
        agent: { title: "双 Agent", desc: "支持 OpenCode 与 Zero，一键热切换" },
      },
      steps: {
        title: "快速开始",
        items: [
          "在下方选择一个 Code Agent（OpenCode 或 Zero）",
          "点击左侧项目名的 [+] 新建会话",
          "在对话框中输入任务，Agent 自动执行",
        ],
      },
    },
  },
