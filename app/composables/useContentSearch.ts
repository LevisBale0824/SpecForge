// ---------------------------------------------------------------------------
// Content Search (CSS Custom Highlight API)
// ---------------------------------------------------------------------------
// Provides in-window text search using TreeWalker + CSS Custom Highlight API.
// Supports next/prev navigation, debounced search, and global exclusivity.
// Requires Chrome 105+ / Edge 105+.
